...
export default function AdminJobPositionsPage() {
  ...
  const handleEdit = useCallback(
    (position: JobPosition) => {
      router.push(`/${locale}/app/admin/job-positions/edit/${position.id}`);
    },
    [locale, router],
  );
  ...
  const handleDelete = useCallback(
    (position: JobPosition) => {
      router.push(`/${locale}/app/admin/job-positions/delete/${position.id}`);
    },
    [locale, router],
  );
  ...
  useEffect(() => {
    const basePath = `/${locale}/app/admin/job-positions`;
    ...
    <div className="p-4 md:p-8 min-h-screen" style={{ background: "#FFFFFF" }}>
      <div className="max-w-full">
        <div className="mb-6 md:mb-8 flex items-center justify-between">
          ...
          <Link href={`/${locale}/app/admin/job-positions/add`}>
            <Button
              variant="primary"
              style={{
                background: "#0097B2",
